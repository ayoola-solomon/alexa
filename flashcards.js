...
var askQuestion = function(language, currentFlashcardIndex) {
...
var handlers = {
  ...
  'SetMyLanguageIntent': function() {
    this.attributes['language'] = this.event.request.intent.slots.language.value;
    var language = this.attributes['language'];
    var currentFlashcardIndex = this.attributes['currentFlashcardIndex'];
    var question = askQuestion(language, currentFlashcardIndex);

    this.response
        .speak('Okay, I will ask you some questions about ' +
        language + '. Here is your first question. ' +  question).listen(question);
    this.emit(':responseReady');
  },
    ...
    if (userAnswer === correctAnswer) {
      ...
      this.response
          .speak('Nice job! The correct answer is ' + correctAnswer + '. You ' +
            ...
            language + ' questions correct. ' + question)
          .listen(question);
